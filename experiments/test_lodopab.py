...
n2self_reconstructor.load_learned_params('params/lodopab_n2self.pt')
...
reconstructors = [fbp_reconstructor, n2self_reconstructor, fbpunet_reconstructor,  iradonmap_reconstructor,
